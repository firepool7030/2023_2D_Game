...
public class Player extends Entity{
    ...
    public void getAttackImage() {
        ...
        if (currentWeapon.type == type_axe) {
            ...
            attackDown1 = setup("/player/boy_axe_down_1", gp.tileSize, gp.tileSize);
    ...
    public void update() {
        ...
        if (knockBack == true) {
        ...
        else if (KeyH.up == true || KeyH.down == true || KeyH.left == true || KeyH.right == true || KeyH.enterPressed == true) {
            ...
            //충돌감지가 활성화 되었을 떄 움직이지 못하게 하는 부분
            collisionOn = false;
            gp.cChecker.checkTile(this);
